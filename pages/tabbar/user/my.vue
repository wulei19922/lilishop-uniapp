	...
	<view class="user">
		...
		<div class="pointBox box">
			<u-row text-align="center" gutter="16" class="point">
				<u-col text-align="center" span="4"  @click="navigateTo('/pages/mine/point/myPoint?pointClass=POINT_A')">
					<view>A积分</view>
					<view class="money">{{ pointA}}</view>
				</u-col>

				<u-col text-align="center" span="4"  @click="navigateTo('/pages/mine/point/myPoint?pointClass=POINT_B')">
					<view>B积分</view>
					<view>{{ pointB || 0 }}</view>
				</u-col>

				<u-col text-align="center" span="4"  @click="navigateTo('/pages/mine/point/myPoint?pointClass=POINT_C')">
					<view>C积分</view>
					<view>{{ pointC || 0 }}</view>
				</u-col>
			</u-row>
		...
		methods: {
			...
			async getUserOrderNum() {
				...
				Promise.all([
					...
					this.pointA = res[2].data.result.pointA;
					this.pointB = res[2].data.result.pointB;
					this.pointC = res[2].data.result.pointC;
				});
			},
		},
	};
